...
public class RobotState {
  ...
  public AimingParameters getAimingParameters() {
    ...
    Rotation2d robotToGoalAngle = originToGoal.minus(originToRobot).getAngle();
    ...
    Rotation2d driveHeading = robotToGoalAngle;
    // Distance to virtual goal
    double effectiveDistance = originToRobot.getDistance(originToGoal);
