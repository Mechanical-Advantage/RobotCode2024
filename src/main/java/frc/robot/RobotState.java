...
public class RobotState {
    ...
    /**
     * Predicts what our pose will be in the future. Allows separate translation and rotation lookaheads to account for
     * varying latencies in the different measurements.
     *
