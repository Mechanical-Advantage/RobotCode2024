    ...
    public void periodic() {
        ...
        for (int instanceIndex = 0; instanceIndex < io.length; instanceIndex++) {
            ...
            if (inputs[instanceIndex].timestamps.length == 0) {
                Logger.recordOutput(
                                "AprilTagVision/Inst" + instanceIndex + "/RobotPose",
                                new double[] {});
                Logger.recordOutput(
                                "AprilTagVision/Inst" + instanceIndex + "/RobotPose3d",
                                new double[] {});
        ...
        // Log robot poses
        Logger.recordOutput(
                        "AprilTagVision/RobotPoses", allRobotPoses.toArray(Pose2d[]::new));
        Logger.recordOutput(
                        "AprilTagVision/RobotPoses3d",
                        allRobotPoses3d.toArray(Pose3d[]::new));
        ...
        Logger.recordOutput(
                        "AprilTagVision/TagPoses", allTagPoses.toArray(Pose3d[]::new));
