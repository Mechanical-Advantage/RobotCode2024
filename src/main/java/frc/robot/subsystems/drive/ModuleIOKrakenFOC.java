...
public class ModuleIOKrakenFOC implements ModuleIO {
    ...
    public ModuleIOKrakenFOC(ModuleConfig config) {
        ...
        turnConfig.MotorOutput.Inverted = config.turnMotorInverted() ?
        ...
        if (KrakenDriveConstants.useMotionMagic) {
            turnConfig.MotionMagic.MotionMagicCruiseVelocity = KrakenDriveConstants.motionMagicCruiseVelocity;
...
//        turnTalon.optimizeBusUtilization();
    ...
    public void updateInputs(ModuleIOInputs inputs) {
        ...
        inputs.odometryDrivePositionsMeters =
                drivePositionQueue.stream()
                        .mapToDouble(
                                signalValue -> Units.rotationsToRadians(signalValue) * wheelRadius)
                        .toArray();
    ...
    public void setDriveVelocitySetpoint(double velocityRadsPerSec, double ffVolts) {
        ...
        if (KrakenDriveConstants.useTorqueCurrentFOC) {
            ...
            driveTalon.setControl(new VelocityVoltage(velocityRotationsPerSec)
    ...
    public void setTurnPositionSetpoint(double angleRads) {
        ...
        if (KrakenDriveConstants.useTorqueCurrentFOC) {
            ...
            if (KrakenDriveConstants.useMotionMagic) {
                turnTalon.setControl(new MotionMagicVoltage(angleRotations)
                        .withEnableFOC(true));
            } else {
                turnTalon.setControl(new PositionVoltage(angleRotations)
                        .withEnableFOC(true));
            }
        }
    }
    ...
    public void setDriveBrakeMode(boolean enable) {
        driveTalon.setNeutralMode(enable ?
                NeutralModeValue.Brake : NeutralModeValue.Coast);
    }

    @Override
    public void setTurnBrakeMode(boolean enable) {
        turnTalon.setNeutralMode(enable ?
                NeutralModeValue.Brake : NeutralModeValue.Coast);
    }
