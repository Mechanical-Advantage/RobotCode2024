...
public class DriveTrajectories {
  ...
  public static final Pose2d startingLineSpike2 =
      new Pose2d(
          ...
          Rotation2d.fromDegrees(180.0));
  public static final Pose2d startingLineAmp =
      new Pose2d(
          FieldConstants.startingLineX - 0.5,
  ...
  static {
    ...
    paths.put(
        ...
        List.of(
            PathSegment.newBuilder()
                .addPoseWaypoint(startingLineAmp)
                .addPoseWaypoint(
                    new Pose2d(
                            FieldConstants.StagingLocations.centerlineTranslations[4],
                            Rotation2d.fromDegrees(-160.0))
                ...
                .build()));
    paths.put(
        "centerline4ToCenterline3",
        List.of(
            PathSegment.newBuilder()
                .addWaypoints(getLastWaypoint("ampToCenterline4"))
                .addPoseWaypoint(
                    new Pose2d(
                            FieldConstants.StagingLocations.centerlineTranslations[3],
                            Rotation2d.fromDegrees(135.0))
    ...
    paths.put(
        ...
        List.of(
            PathSegment.newBuilder()
                .addWaypoints(getLastWaypoint("centerline4ToCenterline3"))
                .addTranslationWaypoint(wingLeftAvoidance)
                .addPoseWaypoint(
                    new Pose2d(
                            FieldConstants.StagingLocations.centerlineTranslations[2],
                ...
                .build()));
    paths.put(
        "centerline2ToCenterline1",
        List.of(
            PathSegment.newBuilder()
                .addWaypoints(getLastWaypoint("centerline3ToCenterline2"))
                .addTranslationWaypoint(stageCenterAvoidance)
                .addPoseWaypoint(
                    new Pose2d(
                            FieldConstants.StagingLocations.centerlineTranslations[1],
